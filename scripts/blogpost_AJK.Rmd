...
pacman::p_load(dplyr,tidyverse, lubridate, tidytext, ggplot2, mediumr,quanteda,quanteda.textstats, pbapply, ggwordcloud, topicmodels, widyr, igraph, ggraph)#  ggrepel,text2vec, ,ggfortify,)
...
Next, I turn to the analysis of the sentiment of the articles. I use the Hungarian sentiment dictionary that canbe found [here](http://opendata.hu/hu/dataset/hungarian-sentiment-lexicon). I am interested in two things, first of all just to get a general sense of what drives the sentiment of these articles, I look at the words that contributed most to the values that we will look at. To this end, I visualize the 10 most frequently occuring positive or negative words. 
...
#apply cleaner function on titles
